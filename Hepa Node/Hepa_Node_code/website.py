...
class BackgroundService:
    ...
    def _monitor_loop(self):
        ...
        SENSOR_ORDER = ("MQ135", "MQ7", "MQ2", "MQ4", "MQ6", "TEMP", "HUM")
                ...
                if raw:
                    ...
                    for k in SENSOR_ORDER:
                        if k in raw:
                            ...
                            processed[k] = {
                                "val": str(v),
                                "hist": self._update_history(k, v)
                            }

                    # OVERWRITE COMPLETELY (no merging)
